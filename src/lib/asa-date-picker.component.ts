...
import {slideMotion} from './utility/utils/animation/slide';
import {DateAdapter, GregorianDateAdapter, JalaliDateAdapter} from './utility/classes/asa-date-picker/date-adapter';
import {CustomLabels, DateRange, Lang_Locale, RangeInputLabels} from './utility/utils/models';
...
} from './utility/utils/overlay/overlay';
import {DOCUMENT, NgIf, NgTemplateOutlet} from '@angular/common';
import {AsaDatePickerService, DestroyService} from './asa-date-picker.service';
import {fromEvent, takeUntil} from 'rxjs';
import {CalendarType, DatepickerMode, Placement, RangePartType, ValueFormat} from './utility/utils/types';
import {DateMaskDirective} from './utility/utils/input-mask.directive';
import {CustomTemplate} from './utility/utils/template.directive';

@Component({
  selector: 'asa-date-picker',
  changeDetection: ChangeDetectionStrategy.OnPush,
  standalone: true,
  templateUrl: './asa-date-picker.component.html',
  styleUrls: ['./asa-date-picker.component.scss'],
  host: {
...
export class AsaDatePickerComponent implements ControlValueAccessor, OnInit, OnChanges, AfterViewInit, OnDestroy {
  ...
  @Input() disableCalendarInteraction: boolean = false;
  // ========== Class Properties ==========
